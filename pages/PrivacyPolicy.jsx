        ...
        <div className={styles.container__main__content}>
          <div className={styles.container__main__content__mainleft}>
            ...
            <div className={styles.container__main__content__mainleft__pagecontent}>
              ...
              <div>   The following Privacy Policies govern how <span> <b> Mobiles4u</b></span> collects and utilizes the information obtained from users (each  User ) z of the <Link href='/Home'> www.mobiles4u.com.pk</Link>. Mobiles4u.com.pk , along with its services, is subject to the following privacy and data protection policies.
              </div>
              <h3> Individual Identification Details</h3>
              <div> Depending on the circumstances, we may collect Users  personal information. However, it is not restricted to when Users browse our website, fill out a form, or participate in other actions, services, features, or resources we offer. Users might be asked for names, if appropriate, or email addresses and names.
              ...
              <h3> Security</h3>
              <div>  Our website is equipped with industry-standard security
              ...
              <h3> Advertising</h3>
              <div> Advertisements on our website could be sent to Users through
                ...
                policy doesn t apply to any cookies used by advertising companies.</div>
              <h3>  Privacy Policies Are Changing.</h3>
              <div> <span> <b> Mobiles4u</b></span> retains the option to modify or change this privacy
              ...
              <div>  Google could display certain ads. Using the DART cookie can show ads
              ...
              <h3>  Contact Us</h3>
              <div>  Suppose you have a question or concern about this privacy statement or any other terms of use, conditions, queries, or concerns about how we manage your Personal Information, don t hesitate to contact our admin department.
                Contact us via:</div>
              <div>   mobiles4u.work@gmail.com</div>
              <div>  Phone: 03037383304</div>
            </div>
          </div>
